...
>
    <div class="text-2xl font-bold p-4">Impressum</div>

    <p class="mx-8 my-6">
        Angaben gemäß § 5 TMG:<br/><br/>
        Anton Jäger<br/>Jahnstr. 9<br/>97286 Sommerhausen<br/><br/>
        Vertreten durch:<br/><br/>
        Anton Jäger<br/><br/>
        Kontakt:<br/><br/>
        E-Mail:fienix.and.izio@gmail.com<br/><br/>
