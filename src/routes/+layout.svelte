        ...
        <ul class="flex flex-wrap items-center space-x-3">
          <li>
            <a target="_blank" rel="noopener noreferrer" href="https://youtube.com/@faivods" >
              <svg height="35px" width="35px" version="1.1"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 461.001 461.001" class="fill-white hover:fill-nixo hvr-transition">
                <g>
          ...
          <li>
            <a target="_blank" rel="noopener noreferrer" href="https://instagram.com/fienix_and_izio" >
              <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px"  viewBox="0 0 132.004 132" xmlns:xlink="http://www.w3.org/1999/xlink" class="fill-white hover:fill-nixo hvr-transition">
